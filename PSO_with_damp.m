...
% ---- GÜNCELLENEN BÖLÜM: 4. KATSAYI EKLENDİ ----
w = 0.489;          % Başlangıç Atalet Ağırlığı (Inertia Weight)
w_damp = 0.9;  % 4. KATSAYI: Atalet Sönümleme Katsayısı (Yakınsamayı Sağlar)
c1 = 2.556;         % Bilişsel (Cognitive) Öğrenme Katsayısı
c2 = 1.667;         % Sosyal (Social) Öğrenme Katsayısı
% -----------------------------------------------
...
for iter = 1:max_iter
    ...
    % ---- GÜNCELLENEN BÖLÜM: YAKINSAMA İÇİN W DEĞERİNİ SÖNÜMLE ----
    w = w * w_damp; 
    % -------------------------------------------------------------
